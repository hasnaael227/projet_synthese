    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <a href="{{ route('formateurs.edit') }}" class="btn btn-primary">Modifier le Profil</a>
                <a href="{{ route('formateurs.change_password') }}" class="btn btn-secondary">Changer le Mot de Passe</a>
            </div>
        </div>
    </div>
</div>
